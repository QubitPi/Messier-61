        ...
        <section className={styles.glass}>
          <div className={styles.dashboard}>
            <div className={styles.user}>
              <img src="https://QubitPi.github.io/Messier-61/img/logo.svg" width="100px" alt="" />
              <h3>Messier 61</h3>
            ...
            <div className={styles.links}>
              ...
              <div className={styles.link}>
                ...
                <a href="https://github.com/QubitPi/Messier-61">
                  <h2>GitHub</h2>
                </a>
              </div>
              <div className={styles.link}>
                <img src={wikiIcon} width="40px" alt="" />
                <a href="https://QubitPi.github.io/Messier-61/">
                  <h2>Help</h2>
                </a>
              </div>
            </div>
